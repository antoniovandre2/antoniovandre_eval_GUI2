...
Owner: Antonio Vandré Pedrosa Furtunato Gomes. (bit.ly/antoniovandre_legadoontologico).

README of "antoniovandre_eval_gui".
____________________

A calculator developed in C, with graphical interface in Python.
